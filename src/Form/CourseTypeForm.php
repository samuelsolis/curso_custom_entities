...
class CourseTypeForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    /* @var $entity_type \Drupal\course\Entity\CourseType */
    ...
    $form['contentType'] = [
      ...
      '#description' => $this->t("Course content type related with this bundle: online course, monthly...."),
      '#maxlength' => 255,
      '#default_value' => $entity_type->getContentType(),
      '#required' => TRUE,
    ];
